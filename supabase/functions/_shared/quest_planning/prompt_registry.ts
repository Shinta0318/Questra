...
export const PROMPTS: Record<string, PromptDefinition> = {
  ...
  route_mission_generation: {
    key: "route_mission_generation", version: 3, status: "active", modelRole: "mission_generator", thinkingLevel: "high", schemaKey: "RouteMissionPlan", temperature: 0.25,
  ...
  route_mission_repair: {
    key: "route_mission_repair", version: 3, status: "active", modelRole: "targeted_repair", thinkingLevel: "medium", schemaKey: "RouteMissionRepairResult", temperature: 0.2,
