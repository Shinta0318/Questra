  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: QuestraSurfacePalette.dark.background,
        borderRadius: AppRadius.glassCard,
        border: Border.all(color: AppColors.gold.withValues(alpha: 0.28)),
      ),
      child: QuestraSurfaceScope(
        ...
        child: Column(
          ...
          children: [
            ...
            _ExperienceSwitch(
              ...
              onChanged: (value) =>
                  controller.apply(settings.copyWith(hapticsEnabled: value)),
            ),
            _ExperienceSwitch(
            ...
            _ExperienceSwitch(
              ...
              onChanged: (value) =>
                  controller.apply(settings.copyWith(powerSavingMode: value)),
            ),
          ],
        ),
      ),
